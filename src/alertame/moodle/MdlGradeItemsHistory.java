...
/**
 * MdlGradeItemsHistory generated by hbm2java
 */
public class MdlGradeItemsHistory  implements java.io.Serializable {
    ...
    public MdlGradeItemsHistory() {
    }

	
    public MdlGradeItemsHistory(long action, long oldid, String itemtype, short gradetype, BigDecimal grademax, BigDecimal grademin, BigDecimal gradepass, BigDecimal multfactor, BigDecimal plusfactor, BigDecimal aggregationcoef, long sortorder, long hidden, long locked, long locktime, long needsupdate) {
        this.action = action;
        this.oldid = oldid;
    ...
    public MdlGradeItemsHistory(long action, long oldid, String source, Long timemodified, Long loggeduser, Long courseid, Long categoryid, String itemname, String itemtype, String itemmodule, Long iteminstance, Long itemnumber, String iteminfo, String idnumber, String calculation, short gradetype, BigDecimal grademax, BigDecimal grademin, Long scaleid, Long outcomeid, BigDecimal gradepass, BigDecimal multfactor, BigDecimal plusfactor, BigDecimal aggregationcoef, long sortorder, long hidden, long locked, long locktime, long needsupdate) {
       this.action = action;
       this.oldid = oldid;
       this.source = source;
