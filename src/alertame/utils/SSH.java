...
public class SSH {
    ...
    private final int local_port = 5520;
    // Remote host and port
    private final int remote_port = 3306;
    private final String remote_host = "nead-espelho.ufrr.br";
    ...
    public int connect() {
        ...
        try {
            ...
            session = jsch.getSession("alunomonografia", remote_host, 22);
            session.setPassword("912w7P2oLoFo2");
